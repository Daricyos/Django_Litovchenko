...
class StudentForm(forms.ModelForm):
    ...
    phone = forms.CharField(label='Phone', required=False, validators=[phone_regex], empty_value=None, widget=forms.TextInput(attrs={'placeholder': '380xxxxxxxxx'}), max_length=15)
